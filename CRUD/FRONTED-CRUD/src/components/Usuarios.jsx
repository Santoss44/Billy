  ...
  return (
    ...
    <div className="container mt-1">
        ...
        <table className="table border">
            <thead className="hola">
                <tr className="hola1">
                    <th className="hola2">Nombre</th>
                    <th className="hola2">Apellido</th>
                    <th className="hola2">Telefono</th>
                    <th className="hola2">Actualizar</th>
                    <th className="hola2">Eliminar</th>
                </tr>
            </thead>
            <tbody>
